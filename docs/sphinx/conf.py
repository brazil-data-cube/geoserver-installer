...
"""Configuration file for the GeoServer Installer CLI documentation.
...
import geoserver_installer
import sphinx_rtd_theme


# -- Project information -----------------------------------------------------

project = 'GEOSERVER_INSTALLER'
copyright = '2021, INPE.'
author = 'Brazil Data Cube Team'
release = geoserver_installer.__version__
...
html_title = 'GEOSERVER_INSTALLER'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'geoserver_installer',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#GEOSERVER_INSTALLER_EXAMPLE_URL = os.getenv('GEOSERVER_INSTALLER_EXAMPLE_URL', None)
#'''
